        ...
        >   
            ...
            <el-table-column prop="title" label="作品名" width="150px">
              <template #default="scope">
                ...
                <router-link v-else :to="{name: 'title', params: { id: scope.row.id }}" tag="span">
                  <span>{{ scope.row.title }}</span>
                </router-link>
              </template>
            </el-table-column>
            <el-table-column prop="zh-title" label="中譯" width="100px" />
            <el-table-column prop="author" label="作者" width="100px" />
            <el-table-column prop="stars" label="給分" width="120px" />
            <el-table-column prop="process" label="進度" width="70px" />
        </el-table>
    </el-main>
  </el-container>
</template>
